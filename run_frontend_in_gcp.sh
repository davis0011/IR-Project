...
REGION=us-central1
ZONE=us-central1-c
PROJECT_NAME="first-project-370308"
IP_NAME="$PROJECT_NAME-ip"
GOOGLE_ACCOUNT_NAME="shavitda" # without the @post.bgu.ac.il or @gmail.com part
...
gcloud compute scp /home/dataproc/search_frontend.py $GOOGLE_ACCOUNT_NAME@$INSTANCE_NAME:/home/$GOOGLE_ACCOUNT_NAME
gcloud compute scp /home/dataproc/inverted_index.py $GOOGLE_ACCOUNT_NAME@$INSTANCE_NAME:/home/$GOOGLE_ACCOUNT_NAME
